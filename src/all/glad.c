/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.34 on Sun Sep 20 20:54:11 2020.
    ...
    Commandline:
	--profile="core" --api="gl=4.6,gles2=3.2,glsc2=2.0,gles1=1.0" --generator="c"
   --spec="gl" --local-files
...
static void load_GL_EXT_shader_pixel_local_storage2(GLADloadproc load)
{
	...
	(PFNGLCLEARPIXELLOCALSTORAGEUIEXTPROC)load("glClearPixelLocalStorageuiEXT");
}
...
static void load_GL_IMG_bindless_texture(GLADloadproc load)
{
	...
	(PFNGLPROGRAMUNIFORMHANDLEUI64IMGPROC)load("glProgramUniformHandleui64IMG");
    glad_glProgramUniformHandleui64vIMG =
	(PFNGLPROGRAMUNIFORMHANDLEUI64VIMGPROC)load("glProgramUniformHandleui64vIMG");
}
...
static void load_GL_QCOM_motion_estimation(GLADloadproc load)
{
	...
	(PFNGLTEXESTIMATEMOTIONREGIONSQCOMPROC)load("glTexEstimateMotionRegionsQCOM");
}
static void load_GL_QCOM_shader_framebuffer_fetch_noncoherent(GLADloadproc load)
{
	...
	(PFNGLFRAMEBUFFERFETCHBARRIERQCOMPROC)load("glFramebufferFetchBarrierQCOM");
}
...
static void load_GL_OES_matrix_palette(GLADloadproc load)
{
	...
	(PFNGLLOADPALETTEFROMMODELVIEWMATRIXOESPROC)load("glLoadPaletteFromModelViewMatrixOES");
