...
// 2020-09-28
// app_ground.cpp v0.0 (OpenGL Code Snippets)
//
...
// App_ground::key_callback {{{1
void
App_ground::key_callback(Key key, int scancode, Key_action action, Key_mods mods)
{
    using std::cout;
...
void
App_ground::initialize(Options &os)
{
